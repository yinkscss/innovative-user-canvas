...
const HeroSection: React.FC = () => {
  ...
  return (
    <section id="home" className="min-h-screen relative pt-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12 h-[90vh] flex flex-col md:flex-row items-center justify-center">
        <div className="md:w-1/2 space-y-6 z-10">
          ...
          <div className="max-w-xl space-y-6 mt-8">
            <AnimatedText
              text="I'm a passionate web developer with a love for crafting beautiful, functional websites and applications."
              className="text-xl text-portfolio-light/80 leading-relaxed"
              delay={0.4}
            />
            ...
            <div className="pt-4 opacity-0 animate-fade-in delay-700">
              <a 
                href="#projects" 
                className="inline-flex items-center gap-2 bg-gradient-to-r from-portfolio-accent to-portfolio-highlight text-white px-6 py-3 rounded-full font-medium hover:shadow-lg hover:shadow-portfolio-accent/30 transition-all duration-300 group"
              >
                View my work
