...
const SkillCard: React.FC<SkillCardProps> = ({ icon, title, description, delay }) => {
  ...
  return (
    <div 
      ref={cardRef}
      className="glass-card p-6 rounded-xl opacity-0 transition-all duration-300 hover:shadow-lg hover:shadow-portfolio-accent/20"
    >
...
const AboutSection: React.FC = () => {
  ...
  return (
    <section 
      id="about" 
      ref={sectionRef} 
      className="relative py-20 overflow-hidden bg-gradient-radial from-portfolio-card to-portfolio-dark"
    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-portfolio-light/80 mb-4">
                With over 8 years of experience in web development, I've worked on a wide range of projects from small business websites to large-scale enterprise applications.
              </p>
              <p className="text-portfolio-light/80 mb-4">
            ...
            <div className="flex justify-center">
              <div className="relative">
                ...
                <img 
                  src="/lovable-uploads/342ecac4-ed1c-4486-bd97-d2a41c350256.png" 
                  alt="Developer" 
                  className="rounded-2xl relative z-10 max-w-full h-auto"
                />
              </div>
            </div>
          </div>
